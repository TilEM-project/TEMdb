...
erDiagram
    ...
    TileDocument {
        ...
        float std_value
        string image_path
        listtemdbmodelstileM... matcher
        str|None supertile_id
        dictstrint|None supertile_raster_position
        string tile_id
        string acquisition_id
        AcquisitionDocument acquisition_ref FK
        int raster_index
    }

    AcquisitionDocument }o--|| TileDocument : acquisition_ref
